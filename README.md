# Jupyter Notebook Submissions of ul-lucid-lovelace
...
```
tira-run --image registry.webis.de/code-research/tira/tira-user-ul-lucid-lovelace/submission:0.0.1 --input-dataset workshop-on-open-web-search/query-processing-20231027-training
```
...
```
docker push registry.webis.de/code-research/tira/tira-user-ul-lucid-lovelace/submission:0.0.1
```
